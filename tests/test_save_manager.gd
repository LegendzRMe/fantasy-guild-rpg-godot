...
static func run() -> Array:
	...
	TestSupport.check(errors,testing.heroes.size()==15,"The testing slot should include every current class fixture, including Protector, and Special Hero candidates.")
	...
	TestSupport.check(errors,legacy_testing.heroes.size()==15 and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Slayer") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Priest") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Shaman") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Templar") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Protector") and legacy_testing.heroes.any(func(hero):return str(hero.get("name",""))=="Ilyra Voss"),"Legacy testing saves should automatically receive every current testing hero and class without duplicating existing heroes.")
