...
static func run() -> Array:
	...
	TestSupport.check(errors,testing.heroes.size()==24,"The testing slot should include every current class fixture, both Death Knight mastery states, Beastmaster, Monk, Paladin, and Special Hero candidates.")
	...
	TestSupport.check(errors,legacy_testing.heroes.size()==24 and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Paladin") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Monk") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Slayer") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Priest") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Shaman") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Templar") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Protector") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Sentinel") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Huntsman") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Druid") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Warrior") and legacy_testing.heroes.any(func(hero):return str(hero.get("class",""))=="Beastmaster") and legacy_testing.heroes.filter(func(hero):return str(hero.get("class",""))=="Death Knight").size()==2 and legacy_testing.heroes.any(func(hero):return str(hero.get("name",""))=="Ilyra Voss"),"Legacy testing saves should automatically receive every current testing hero, Paladin, both Death Knight fixtures, Beastmaster, Monk, and Special Heroes without duplicates.")
