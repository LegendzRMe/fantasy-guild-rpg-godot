...
func guardian_talent_name(talent_id: String) -> String:
	...
	if talent_id.begins_with("beastmaster_"):
		return str(BeastmasterData.WORKING_NAMES.get(talent_id, talent_id.replace("_", " ").capitalize()))
	if talent_id.begins_with("monk_"):
		return str(MonkData.WORKING_NAMES.get(talent_id, talent_id.replace("_", " ").capitalize()))
	if talent_id.begins_with("paladin_"):
		return str(PaladinData.WORKING_NAMES.get(talent_id, talent_id.replace("_", " ").capitalize()))
	if talent_id.begins_with("crusader_"):
		return str(CrusaderData.WORKING_NAMES.get(talent_id, talent_id.replace("_", " ").capitalize()))
	if talent_id.begins_with("vanguard_"):
...
func roster_talent_description(hero_class: String, option_id: String) -> String:
	...
	if hero_class == "Beastmaster":
		return str(BeastmasterData.TALENT_DESCRIPTIONS.get(option_id, "Talent details are still being developed."))
	if hero_class == "Monk":
		return str(MonkData.TALENT_DESCRIPTIONS.get(option_id, "Talent details are still being developed."))
	if hero_class == "Paladin":
		return str(PaladinData.TALENT_DESCRIPTIONS.get(option_id, "Talent details are still being developed."))
	if hero_class == "Crusader":
		return str(CrusaderData.TALENT_DESCRIPTIONS.get(option_id, "Talent details are still being developed."))
	if hero_class == "Vanguard":
