...
const ENEMIES := {
	"Dummy":{"base_health":150.0,"health_growth":0.03,"base_power":0.0,"power_growth":0.03,"base_armor":0.0,"basic_action_type":"attack","basic_action_power_coefficient":0.0,"basic_action_interval":2.0,"basic_action_range":0.0,"movement_speed":0.0,"base_critical_chance":0.0,"critical_damage":2.0,"basic_action_damage_type":"physical","behavior_flags":[],"combat_tags":["training"],"control_profile":{"displacement":false},"color":Color("9a7652")},
	"Defense Dummy":{"base_health":5000.0,"health_growth":0.03,"base_power":12.0,"power_growth":0.03,"base_armor":15.0,"basic_action_type":"attack","basic_action_power_coefficient":1.0,"basic_action_interval":1.8,"basic_action_range":125.0,"movement_speed":0.0,"base_critical_chance":0.0,"critical_damage":2.0,"basic_action_damage_type":"physical","behavior_flags":["ranged","stationary"],"combat_tags":["training","defense"],"control_profile":{"displacement":false},"color":Color("c06f45"),"ranged":true},
