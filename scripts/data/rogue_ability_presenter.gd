...
static func details(hero:Dictionary,key:String,heroic_id:String="",stealth:bool=false)->Dictionary:
	...
	match key:
		...
		"D":return {"key":"D","title":"Vanish","meta":"Cooldown: 8 seconds","description":"Become Stealthed, gain 20% Movement Speed, and replace Q, W, and E with opener abilities.","sections":[{"heading":"PREPARATION","body":"The first second is Unrevealable. Remaining stationary for 1.5 seconds grants Invisible. After 3 seconds, openers gain doubled range and teleport."}],"note":"Combo Points persist when entering or leaving Vanish."}
