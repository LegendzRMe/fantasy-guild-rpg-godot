...
const ABILITIES := {"Guardian":["Storm Bolt","Thunder Clap","Dwarf Toss","Avatar"],"Cleric":["Healing Brew","Cloud Serpent","Blinding Wind","Heroic Ability"],"Rogue":["Veiled Strike","Shadowstep","Fan of Knives","Deathmark"],"Ranger":["Hungering Arrow","Multishot","Vault","Heroic Ability"],"Mage":["Flamestrike","Living Bomb","Gravity Lapse","Heroic Ability"],"Warlock":["Blackflame Bolt","Dark Passage","Withering Circle","Soulstorm"]}
const TRAITS := {"Guardian":"Second Wind","Cleric":"Fast Feet","Rogue":"Opportunist","Ranger":"Hatred","Mage":"Verdant Spheres","Warlock":"Soulbrand"}
const ABILITY_TARGETING := {"Guardian":["directional","self","ground","self"],"Cleric":["self","ally","self","self"],"Rogue":["enemy","directional","area","enemy"],"Ranger":["directional","directional","ground","directional"],"Mage":["ground","enemy","directional","ground"],"Warlock":["enemy","ground","ground","area"]}
const ABILITY_RANGES := {"Guardian":[390.0,0.0,235.0,0.0],"Cleric":[0.0,260.0,0.0,0.0],"Rogue":[0.0,160.0,120.0,0.0],"Ranger":[RangerData.SPACE.q_range,RangerData.SPACE.w_end_radius,RangerData.SPACE.e_range,RangerData.SPACE.rain_length],"Mage":[MageData.SPACE.q_cast_range,MageData.SPACE.w_cast_range,MageData.SPACE.e_range,MageData.SPACE.phoenix_cast_range],"Warlock":[0.0,330.0,270.0,0.0]}
