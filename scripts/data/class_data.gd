...
const CLASSES := {
	...
	"Paladin":PaladinData.CLASS_DEFINITION,
	"Crusader":CrusaderData.CLASS_DEFINITION,
	"Vanguard":VanguardData.CLASS_DEFINITION,
	"Vitalist":VitalistData.CLASS_DEFINITION,
	"Spirit Weaver":SpiritWeaverData.CLASS_DEFINITION
}

const ABILITIES := {"Guardian":["Storm Bolt","Thunder Clap","Dwarf Toss","Avatar"],"Cleric":["Healing Brew","Cloud Serpent","Blinding Wind","Heroic Ability"],"Rogue":["Sinister Strike","Blade Flurry","Eviscerate","Heroic Ability"],"Ranger":["Hungering Arrow","Multishot","Vault","Heroic Ability"],"Mage":["Flamestrike","Living Bomb","Gravity Lapse","Heroic Ability"],"Warlock":["Fel Flame","Drain Life","Corruption","Heroic Ability"],"Slayer":["Dive","Sweeping Strike","Evasion","Heroic Ability"],"Priest":["Flash Heal","Divine Star","Chastise","Heroic Ability"],"Shaman":["Chain Lightning","Feral Spirit","Windfury","Heroic Ability"],"Templar":["Blade Dash","Twin Blades","Shield Ally","Heroic Ability"],"Protector":["El'druin's Might","Force Wall","Smite","Heroic Ability"],"Sentinel":["Light of Elune","Sentinel Shot","Lunar Flare","Heroic Ability"],"Huntsman":["Gilnean Cocktail","Inner Beast","Darkflight","Heroic Ability"],"Druid":["Regrowth","Moonfire","Entangling Roots","Heroic Ability"],"Warrior":["Lion's Fang","Parry","Charge","Specialization"],"Death Knight":["Death Coil","Howling Blast","Frozen Tempest","Heroic Ability"],"Beastmaster":["Spirit Swoop","Misha, Charge!","Greater Beast","Heroic Ability"],"Monk":["Radiant Dash","Breath of Heaven","Deadly Reach","Heroic Ability"],"Paladin":["Vindication","Righteous Hammer","Avenging Wrath","Heroic Ability"],"Crusader":["Punish","Condemn","Shield Glare","Heroic Ability"],"Vanguard":["Powerslide","Face Melt","Overpower","Heroic Ability"],"Vitalist":["Healing Pathogen","Weighted Pustule","Lurking Arm","Heroic Ability"],"Spirit Weaver":["Chain Heal","Lightning Shield","Earthbind Totem","Heroic Ability"]}
const TRAITS := {"Guardian":"Second Wind","Cleric":"Fast Feet","Rogue":"Vanish","Ranger":"Hatred","Mage":"Verdant Spheres","Warlock":"Life Tap","Slayer":"Betrayer's Thirst","Priest":"Pursued by Grace","Shaman":"Frostwolf Resilience","Templar":"Shield Overload","Protector":"Archangel's Wrath","Sentinel":"Hunter's Mark","Huntsman":"Curse of the Worgen","Druid":"Innervate","Warrior":"Heroic Strike","Death Knight":"Frostmourne Hungers","Beastmaster":"Misha, Focus!","Monk":"Chosen Trait","Paladin":"Divine Purpose","Crusader":"Iron Skin","Vanguard":"Rockstar","Vitalist":"Bio-Kill Switch","Spirit Weaver":"Purge / Ghost Wolf"}
const ABILITY_TARGETING := {"Guardian":["directional","self","ground","self"],"Cleric":["self","ally","self","self"],"Rogue":["directional","self","enemy","self"],"Ranger":["directional","directional","ground","directional"],"Mage":["ground","enemy","directional","ground"],"Warlock":["directional","enemy","directional","ground"],"Slayer":["enemy","ground","self","ground"],"Priest":["self","directional","directional","self"],"Shaman":["enemy","directional","self","directional"],"Templar":["directional","enemy","self","ground"],"Protector":["ground","ground","ground","enemy"],"Sentinel":["self","directional","ground","ground"],"Huntsman":["directional","self","enemy","enemy"],"Druid":["ally","ground","ground","self"],"Warrior":["directional","self","enemy","enemy"],"Death Knight":["enemy","ground","self","directional"],"Beastmaster":["directional","directional","self","directional"],"Monk":["enemy","self","self","ally"],"Paladin":["self","directional","directional","self"],"Crusader":["directional","self","directional","ground"],"Vanguard":["directional","self","enemy","self"],"Vitalist":["ally","directional","ground","directional"],"Spirit Weaver":["ally","ally","ground","ally"]}
const ABILITY_RANGES := {"Guardian":[390.0,0.0,235.0,0.0],"Cleric":[0.0,260.0,0.0,0.0],"Rogue":[134.55,75.68,50.45,0.0],"Ranger":[386.36,294.32,168.18,329.45],"Mage":[319.55,185.0,336.36,336.36],"Warlock":[353.18,235.45,336.36,336.36],"Slayer":[151.36,109.32,0.0,134.55],"Priest":[269.09,294.32,353.18,0.0],"Shaman":[390.0,390.0,0.0,405.0],"Templar":[TemplarData.SPACE.q_distance,TemplarData.SPACE.w_charge,0.0,INF],"Protector":[ProtectorData.SPACE.q_range,ProtectorData.SPACE.w_range,ProtectorData.SPACE.e_range,ProtectorData.SPACE.r1_range],"Sentinel":[0.0,SentinelData.SPACE.w_range,SentinelData.SPACE.e_range,SentinelData.SPACE.e_range],"Huntsman":[HuntsmanData.SPACE.cocktail_range,0.0,HuntsmanData.SPACE.darkflight_range,HuntsmanData.SPACE.heroic_range],"Druid":[DruidData.SPACE.regrowth_range,DruidData.SPACE.moonfire_range,DruidData.SPACE.roots_range,DruidData.SPACE.twilight_radius],"Warrior":[WarriorData.SPACE.lions_fang_range,0.0,WarriorData.SPACE.charge_range,WarriorData.SPACE.colossus_range],"Death Knight":[DeathKnightData.SPACE.death_coil_range,DeathKnightData.SPACE.howling_range,0.0,DeathKnightData.SPACE.sindragosa_range],"Beastmaster":[BeastmasterData.SPACE.swoop_length,BeastmasterData.SPACE.charge_length,0.0,BeastmasterData.SPACE.boar_range],"Monk":[MonkData.SPACE.dash_range,0.0,0.0,MonkData.SPACE.palm_range],"Paladin":[0.0,PaladinData.SPACE.hammer_reach,PaladinData.SPACE.avenging_max,0.0],"Crusader":[CrusaderData.SPACE.punish_radius,0.0,CrusaderData.SPACE.glare_range,CrusaderData.SPACE.blessed_range],"Vanguard":[VanguardData.SPACE.q_range,0.0,VanguardData.SPACE.e_range,0.0],"Vitalist":[VitalistData.SPACE.q_range,VitalistData.SPACE.w_range,VitalistData.SPACE.e_range,VitalistData.SPACE.shove_range],"Spirit Weaver":[SpiritWeaverData.SPACE.q_range,SpiritWeaverData.SPACE.w_range,SpiritWeaverData.SPACE.e_range,SpiritWeaverData.SPACE.ancestral_range]}
const ABILITY_DESCRIPTIONS := {
	"Crusader":["Strike a wide frontal area and apply a decaying Slow.","Prepare for one second while moving, then damage, pull, and briefly Stun nearby enemies.","Damage and Blind enemies in a long cone.","Use Falling Sword or Blessed Shield."],
	"Vanguard":["Slide through enemies, damaging and Stunning them.","Damage and safely displace nearby enemies.","Flip a nearby enemy behind Vanguard, damage it, and briefly Stun.","Use Mosh Pit or Lightning Breath."],
	"Vitalist":["Apply a spreading healing infection.","Launch a hostile infection with a growing Slow.","Channel a damaging, Silencing zone.","Use Flailing Swipe or Massive Shove."],
	"Spirit Weaver":["Heal through a three-Hero chain.","Empower an ally with damaging lightning.","Place a slowing, destructible Totem.","Use Ancestral Healing or Bloodlust."],
	"Paladin":["Charge and release to damage nearby enemies and heal Paladin.","Charge and release a frontal damaging knockback; maximum charge Stuns.","Charge to expand leap distance, then damage and Slow around the safe landing point.","Use Ardent Defender or Sacred Ground."],
