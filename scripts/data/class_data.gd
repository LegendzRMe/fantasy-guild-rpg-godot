...
const CLASS_IDS_BY_DISPLAY_NAME := {"Guardian":"guardian","Cleric":"cleric","Rogue":"rogue","Ranger":"ranger","Mage":"mage","Warlock":"warlock","Slayer":"slayer","Priest":"priest","Shaman":"shaman","Templar":"templar","Protector":"protector","Sentinel":"sentinel"}
