...
const DeathKnightAbilityPresenter = preload("res://scripts/data/death_knight_ability_presenter.gd")
...
const BeastmasterAbilityPresenter = preload("res://scripts/data/beastmaster_ability_presenter.gd")
const MonkData = preload("res://scripts/data/monk_data.gd")
const MonkSystem = preload("res://scripts/systems/monk_system.gd")
const MonkAbilityPresenter = preload("res://scripts/data/monk_ability_presenter.gd")
...
const PaladinAbilityPresenter = preload("res://scripts/data/paladin_ability_presenter.gd")
...
const CrusaderAbilityPresenter = preload("res://scripts/data/crusader_ability_presenter.gd")
...
const VanguardAbilityPresenter = preload("res://scripts/data/vanguard_ability_presenter.gd")
...
const VitalistAbilityPresenter = preload("res://scripts/data/vitalist_ability_presenter.gd")
...
const SpiritWeaverAbilityPresenter = preload("res://scripts/data/spiritweaver_ability_presenter.gd")
