...
func _init()->void:
	...
	var independent_paths:=[
		"res://scripts/data/monk_data.gd","res://scripts/data/monk_ability_presenter.gd","res://scripts/systems/monk_system.gd","res://tests/test_monk_system.gd","res://tests/test_ui_monk_runtime.gd","res://scripts/data/vanguard_data.gd","res://scripts/data/vanguard_ability_presenter.gd","res://scripts/systems/vanguard_system.gd","res://tests/test_vanguard_system.gd","res://tests/test_ui_vanguard_runtime.gd","res://scripts/data/vitalist_data.gd","res://scripts/data/vitalist_ability_presenter.gd","res://scripts/systems/vitalist_system.gd","res://tests/test_vitalist_system.gd","res://tests/test_ui_vitalist_runtime.gd","res://scripts/data/spiritweaver_data.gd","res://scripts/data/spiritweaver_ability_presenter.gd","res://scripts/systems/spiritweaver_system.gd","res://tests/test_spiritweaver_system.gd","res://tests/test_ui_spiritweaver_runtime.gd"
	]
