...
func _init()->void:
	...
	for beastmaster_path in ["res://scripts/data/beastmaster_data.gd","res://scripts/data/beastmaster_ability_presenter.gd","res://scripts/systems/summon_health_decay_system.gd","res://scripts/systems/damage_redirection_system.gd","res://scripts/systems/beastmaster_system.gd","res://scripts/runtime/beastmaster_runtime.gd"]:
