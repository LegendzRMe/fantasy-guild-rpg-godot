...
func _init()->void:
	...
	for warrior_path in ["res://scripts/data/warrior_data.gd","res://scripts/systems/warrior_system.gd","res://scripts/runtime/warrior_runtime.gd"]:
		if load(warrior_path)==null:push_error("Unable to prime dependency: "+warrior_path);quit(1);return
	for death_knight_path in ["res://scripts/data/death_knight_data.gd","res://scripts/data/death_knight_ability_presenter.gd","res://scripts/systems/toggle_stance_system.gd","res://scripts/systems/incoming_damage_reduction_system.gd","res://scripts/systems/death_knight_system.gd","res://scripts/runtime/death_knight_runtime.gd"]:
		if load(death_knight_path)==null:push_error("Unable to prime dependency: "+death_knight_path);quit(1);return
	for beastmaster_path in ["res://scripts/data/beastmaster_data.gd","res://scripts/data/beastmaster_ability_presenter.gd","res://scripts/systems/summon_health_decay_system.gd","res://scripts/systems/damage_redirection_system.gd","res://scripts/systems/beastmaster_system.gd","res://scripts/runtime/beastmaster_runtime.gd","res://tests/test_beastmaster_system.gd","res://tests/test_ui_beastmaster_runtime.gd"]:
		if load(beastmaster_path)==null:push_error("Unable to prime dependency: "+beastmaster_path);quit(1);return
